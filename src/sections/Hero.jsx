...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0F172A] scanlines">
      ...
      {/* FLOATING CARDS — desktop seulement */}
      <div className="absolute right-[5%] top-[20%] hidden xl:flex flex-col gap-4 z-10">
        {floatingCards.map((card, i) => (
          <div key={i} className={`holo-card rounded-2xl px-4 py-3 flex items-center gap-3 w-[180px] ${card.className}`}>
      ...
      {/* CONTENU PRINCIPAL */}
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto" ref={refProjets}>
        {/* Badge */}
        <motion.div
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-black text-white mb-4 leading-tight glitch"
        ...
        <motion.div
          ...
          className="text-3xl md:text-5xl font-bold mb-6 h-14 flex items-center justify-center"
        >
          <span className="gradient-text neon-text" style={{ fontFamily: 'Sora, sans-serif' }}>
